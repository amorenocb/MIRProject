"""
Django settings for contentBasedSearch project.
...
SECRET_KEY = 'qio58wd*ebri_*%*y-nz8#bs&_=tfsjjns0c%*735b3)_i@5o3'
...
ROOT_URLCONF = 'contentBasedSearch.urls'
...
WSGI_APPLICATION = 'contentBasedSearch.wsgi.application'
